...
#ifndef OCEANBASE_STORAGE_BLOCKSSTABLE_DEMO_MACRO_BLOCK_WRITER_H_
#define OCEANBASE_STORAGE_BLOCKSSTABLE_DEMO_MACRO_BLOCK_WRITER_H_
...
//  |- MicroBlock 2
//  |- MicroBlock N
class ObDemoMicroBlockBufferHelper
{
public:
  ObDemoMicroBlockBufferHelper();
  ~ObDemoMicroBlockBufferHelper() = default;
  int open(
...
class ObDemoMacroBlockWriter
{
public:
  ObDemoMacroBlockWriter();
  virtual ~ObDemoMacroBlockWriter();
  void reset();
  int open(
      ObDataStoreDesc &data_store_desc,
...
private:
  ...
  ObDemoMicroBlockBufferHelper micro_helper_;
  ObTableReadInfo read_info_;
