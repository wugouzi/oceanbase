...
alias dep='log_info DEPLOY && cddebug && obd mirror create -n oceanbase-ce -V 4.0.0.0 -p ./usr/local/ -f -t final && obd cluster autodeploy final -c ../final_2022.yaml -f'
alias res='log_info RESTART && obd cluster restart final'
alias des='(log_info DESTROY && obd cluster destroy -f final && rm -rf /root/.obd) || true'
alias d='des && dep'
alias md='m && d'
...
alias depr='log_info DEPLOY && cdrelease && obd mirror create -n oceanbase-ce -V 4.0.0.0 -p ./usr/local/ -f -t final && obd cluster autodeploy final -c ../final_2022.yaml -f'
alias dr='des && depr'
alias mdr='mr && dr'
